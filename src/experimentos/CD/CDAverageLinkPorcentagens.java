 ...
 * @author Priscilla
 */
public class CDAverageLinkPorcentagens {
     public void experimentoSemMerge() throws IOException{
       ...
       // double valoresEsperados[] = new double[9];  
        ...
        for (int j = 0; j < tamanhoAmostras.length; j++) {
            ...
            for (int i = 0; i < numeroIteracoes; i++) {
                ...
                cluster.averageLinkIncremental(bi2);//armazena amostra
                ...
                cluster.averageLinkIncremental(bi3);//passa a base toda considerando uma porcentagem armazenada.
 ...
 //Para Calcular Sem reuso
               ...
               AverageLink cluster2 = new AverageLink();
                ...
                cluster2.averageLinkTradicional(bi4);//passa a base toda considerando uma porcentagem armazenada.
    ...
    public void experimentoComMerge() throws IOException{
       ...
       // double valoresEsperados[] = new double[9];  
        ...
        double recallAux[] = new double[9]; 
        double fmeasureAux[] = new double[9];
        double valoreSubtrair[] = new double[9];
        ...
        for (int j = 0; j < tamanhoAmostras.length; j++) {
            ...
            for (int i = 0; i < numeroIteracoes; i++) {
                ...
                cluster.averageLinkIncrementalWithBIAtualizado(bi2);//armazena amostra
                ...
                long tempoInicial = System.currentTimeMillis();
                cluster.averageLinkIncrementalWithBIAtualizado(bi3);//passa a base toda considerando uma porcentagem armazenada.
                
                tempo = tempo+ (System.currentTimeMillis() - tempoInicial);
                
                valoresAcertadosCumilativos[i] = ((double) cluster.getTotalCerto());
                valoreErradosCumulativos[i] = ((double) cluster.getTotalErrado());
                valoreSubtrair[j]=cluster.getTempoParaDiminuir();
 ...
 //Para Calcular Sem reuso
        ...
        System.out.println(" Tempos Com Reuso Para subtrair " );
        for (int i = 0; i < valoreSubtrair.length; i++) {
            System.out.print(" "+valoreSubtrair[i] );
      ...
      public static void main(String[] args) throws IOException {
       ...
       CDAverageLinkPorcentagens experimento = new CDAverageLinkPorcentagens();
       experimento.experimentoSemMerge();
          System.out.println(" Experimento 2 &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&");
          experimento.experimentoComMerge();
