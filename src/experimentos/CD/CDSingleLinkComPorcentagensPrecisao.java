 ...
 * @author Priscilla
 */
public class CDSingleLinkComPorcentagensPrecisao {
 ...
 */
    ...
    public static void main(String[] args) throws IOException {
       ...
       int numeroIteracoes = 5;
        ...
        int tamanhoAmostras[] = {1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 13000};     
 ...
 //Para Calcular Sem reuso
                ...
                cluster2.singleLink2(bi4);//passa a base toda considerando uma porcentagem armazenada.
